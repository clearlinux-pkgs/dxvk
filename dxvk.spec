...
Version  : 1.4.5
Release  : 5
URL      : https://github.com/doitsujin/dxvk/archive/v1.4.5/dxvk-1.4.5.tar.gz
Source0  : https://github.com/doitsujin/dxvk/archive/v1.4.5/dxvk-1.4.5.tar.gz
...
%prep
%setup -q -n dxvk-1.4.5
cd %{_builddir}/dxvk-1.4.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574446268
...
cp %{_builddir}/dxvk-1.4.5/LICENSE %{buildroot}/usr/share/package-licenses/dxvk/4a83b2fbabc7965ffeffdda9b49248867c18e621
cp %{_builddir}/dxvk-1.4.5/include/openvr/LICENSE %{buildroot}/usr/share/package-licenses/dxvk/99e40ce3676d57f631fca8692017203185ab6b5f
%make_install ||:
